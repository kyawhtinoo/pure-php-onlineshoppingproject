			...
			<div class="table-responsive">
				<table class="table">
					...
					<tfoot id="shoppingcart_tfoot">
						<tr>
							<td colspan="8">
								<h3 class="text-right Total_t"></h3>
							</td>
						</tr>
						<tr> 
							<td colspan="5"> 
...
<td colspan="3">
	...
	?>
	<a href="javascript:void(0)"><button class="btn btn-secondary btn-block mainfullbtncolor checkoutBtn"> 
		Check Out 
	</button></a>

		<?php  }else{ ?>				
              <a href="login.php"><button class="btn btn-secondary btn-block mainfullbtncolor "> 
		Check Out 
	</button></a>
                          <?php }?>
                         </td>
