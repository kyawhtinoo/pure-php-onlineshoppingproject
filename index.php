		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
				<div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
				  	<img src="<?php echo $clogo; ?>" class="card-img-top" alt="...">
				  	<div class="card-body">
		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="javascript:void(0)" class="addtocartBtn text-decoration-none ATC_" 
								   data-id="<?= $di_id ?>" 
								   data-name= "<?= $di_name ?>"
								   data-price="<?= $di_price ?>" 
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                <?php 
		            		$bid = 46;
		            		$sql = "SELECT * FROM items WHERE brand_id = :value1 LIMIT 8";
		            		$stmt = $conn->prepare($sql);
